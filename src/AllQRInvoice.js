import { View, Text ,StatusBar, ScrollView, TouchableOpacity, TextInput,Linking} from 'react-native'
                          ...
                          <Card style={{ width: "90%", marginTop: 10, marginBottom: 10, elevation: 5, borderRadius: 10 }}>
                              <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between",marginBottom:10 }}>
                                  ...
                                  <View style={{ width: "40%", flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
                                      ...
                                      <View style={{ flexDirection: "column", width: "60%", justifyContent: "center", alignItems: "center", backgroundColor: "#1ABC9C", marginLeft: 10, height: 25, borderRadius: 50, marginTop: 5 }}>
                                          <TouchableOpacity onPress={() => Linking.openURL(`https://rockel.netlify.app/printQR/${item.id}`)}>
                                              <View style={{ width: "70%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                                                  <Text style={{ color: "#fff", fontSize: 11 ,fontFamily: "Poppins-SemiBold",marginTop:2}}>Print QR</Text>
                                              </View>
                                          </TouchableOpacity>
                                      </View>
                                  </View>
