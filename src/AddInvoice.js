...
import { View, Text, StatusBar, TouchableOpacity, ScrollView, StyleSheet, ActivityIndicator } from 'react-native';
...
export default function AddInvoice({ navigation,route }) {
  ...
  const{bookingId,bookingUniqueId,customerId} =route.params;
  console.log("bookingId",bookingId)
  console.log("bookingUniqueId",bookingUniqueId)
  console.log("customerId",customerId)

  const country_list = ["Virgin Islands (US)", "Yemen", "Zambia", "Zimbabwe"];
  ...
  function handleClick() {
    if(recipientName ===""||email==="" || phone1 ==="" || address1 ==="" || valueArea1 === "" || valueArea ==="" ){
  ...
  const [openArea1, setOpenArea1] = useState(false);
  const [valueArea1, setValueArea1] = useState(null);
  const[itemsArea1,setItemsArea1] =useState([
        ...
        <View style={{ flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          ...
          <View style={{ width: "90%", marginTop: 15 }}>
            ...
            <DropDownPicker
              ...
              value={valueArea1}
              items={itemsArea1}
              setOpen={setOpenArea1}
              setValue={setValueArea1}
              setItems={setItemsArea1}
                  ...
                  <View style={{ backgroundColor: "#D9D9D9", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: 10, marginTop: 15 }}>
                    ...
                    <View style={{ width: "90%", marginTop: 10 }}>
                      <TextInput
                        ...
                        keyboardType='numeric'
                        onChangeText={(text) => handleChange(text, key, 'costPerItem')} value={input.costPerItem} />
                    </View>
