...
export default function Invoice({ navigation }) {
    ...
    const { data, loading, refetch } = useQuery(QUERY_GET_ALL_INVOICE);
                                                        ...
                                                        <Card style={{ width: "90%", marginTop: 10, marginBottom: 10, elevation: 5, borderRadius: 10 }}>
                                                            <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between", marginBottom: 10 }}>
                                                                ...
                                                                <View style={{ width: "40%", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                                                                    <Text style={{ color: "#34495E", fontSize: 9, marginTop: 7, fontFamily: "Poppins-SemiBold" }}><Moment element={Text} format='DD MMM YYYY'>{item.createdDateTime}</Moment> , <Moment element={Text} format='hh:mm A'>{item.createdDateTime}</Moment> </Text>
                                                                    {
                                                                                ...
                                                                                item.status === "PickUp" ?
                                                                                    ...
                                                                                    item.status === "Delivered" ?
                                                                                        ...
                                                                                        item.status === "Container" ?
                                                                                            ...
                                                                                            :
                                                                                            item.status === "Freetown_London" ?
                                                                                            <Text style={{ fontSize: 10, marginLeft: 10, fontFamily: "Poppins-SemiBold", color: "#e67e22" }}>Freetown London</Text>
                                                                                            :
                                                                    ...
                                                                    <TouchableOpacity onPress={() => navigation.navigate("InvoiceDetail", { data: item })}>
                                                                        <View style={{ flexDirection: "column", width: 85, justifyContent: "center", alignItems: "center", backgroundColor: "#1ABC9C", height: 25, borderRadius: 50, marginTop: 1, marginBottom: 10 }}>
                                                                            <Text style={{ color: "#fff", fontSize: 10 }}>View Detail</Text>
                                                                        </View>
                                                                    </TouchableOpacity>
                                                                    {/* <View style={{ flexDirection: "column", width: 85, justifyContent: "center", alignItems: "center", backgroundColor: "#1ABC9C",  height: 25, borderRadius: 50, marginTop: 1,marginBottom:10}}>
                                                                                    <TouchableOpacity onPress={() => navigation.navigate("InvoiceDetail", { data: item })}>
